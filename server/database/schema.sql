...
('Fondant au chocolat', '/assets/uploads/recipes/fonadant_au_chocolat.jpg', 6, 1, 15, 10, 1),
('Bowl au saumon et riz', '/assets/uploads/recipes/bowl_saumon.jpg', 2, 1, 25, 10, 1),
('Spaghetti Carbonara', '/assets/uploads/recipes/carbonarra.jpg', 4, 1, 20, 10, 1),
('Salade Méditerranéenne', '/assets/uploads/recipes/salade_mediterranee.jpg', 4, 1, 00, 10, 1),
('Gratin de Courgette', '/assets/uploads/recipes/gratin_courgette.jpg', 4, 1, 30, 15, 1),
('Paupiettes de veau sauce champignons', '/assets/uploads/recipes/paupiette.jpg', 4, 1, 35, 20, 1),
('Flan Patissier', '/assets/uploads/recipes/flan_patissier.jpg', 6, 1, 40, 15, 1),
('Curry de légumes', '/assets/uploads/recipes/curry_legumes.jpg', 4, 1, 30, 15, 1),
('Quiche aux épinards et fromage', '/assets/uploads/recipes/quiche_epinard.jpg', 6, 1, 40, 15, 1),
('Poêlée de légumes aux lentilles', '/assets/uploads/recipes/poelle_legumes.jpg', 4, 1, 30, 10, 1);
...
(6, 59, 200, 'grammes'),       
(6, 45, 10, 'feuilles'),       
(6, 20, 3, 'cuillères à soupe'),       
(6, 18, 1, 'pincée'),       
(6, 19, 1, 'pincée'),       
(7, 31, 2, 'pièces'),       
(7, 25, 200, 'millilitres'),       
(7, 60, 80, 'grammes'),       
(7, 33, 1, 'gousse'),       
(7, 18, 1, 'pincée'),
(8, 69, 4, 'escalopes'),
...
(8, 42, 100, 'grammes'),
(8, 30, 200, 'grammes'),
(8, 25, 200, 'millilitres'),
(8, 3, 1, 'pièce'),
(8, 20, 2, 'cuillères à soupe'),
(8, 35, 1, 'pincée'),
(8, 18, 1, 'pincée'),
(8, 19, 1, 'pincée'),
(9, 15, 50, 'centilitres'),
...
(10, 3, 100, 'grammes'),
(10, 33, 2, 'gousses'),
(10, 15, 20, 'centilitres'),
(10, 37, 1, 'cuillère à soupe'),
(10, 20, 1, 'cuillère à soupe'),
(10, 28, 200, 'grammes'),
(10, 18, 1, 'pincée'),
(10, 19, 1, 'pincée'),
(11, 49, 200, 'grammes'),
...
(1, "Faites cuire les spaghetti dans une grande casserole d'eau bouillante salée selon les instructions du paquet.", 5),
(2, "Pendant ce temps, faites revenir la viande hachée (ou les lardons) dans une poêle avec un peu de beurre jusqu'à ce qu'elle soit bien dorée.", 5),
(3, "Ajoutez l'ail haché dans la poêle et faites cuire pendant 1 à 2 minutes pour parfumer.", 5),
(4, "Dans un bol, battez les œufs et mélangez-les avec le fromage râpé, le sel et le poivre.", 5),
(5, "Une fois les pâtes cuites, égouttez-les en conservant un peu d'eau de cuisson.", 5),
(6, "Ajoutez les pâtes dans la poêle avec la viande et mélangez bien.", 5),
(7, "Hors du feu, incorporez le mélange œufs-fromage aux pâtes en remuant rapidement pour créer une sauce onctueuse. Si nécessaire, ajoutez un peu d'eau de cuisson pour ajuster la consistance.", 5),
(8, "Servez immédiatement, saupoudré de fromage râpé supplémentaire et de poivre noir.", 5),
(1, "Couper les tomates et la mozzarella en rondelles", 6),
(2, "Disposer en alternance les tranches de tomates et de mozzarella dans un plat.", 6),
(3, "Ajouter les feuilles de basilic", 6),
(4, "Arroser d’huile d’olive, saler et poivrer", 6),
(5, "Servir frais", 6),
(1, "Préchauffer le four à 180°C.", 7),
(2, "Couper les courgettes en rondelles fines.", 7),
(3, "Frotter un plat à gratin avec une gousse d’ail puis disposer les courgettes en couches.", 7),
(4, "Napper avec la crème fraîche et saupoudrer de parmesan.", 7),
(5, "Enfourner 30 minutes jusqu’à ce que le gratin soit bien doré.", 7),
(1, "Aplatir les escalopes si besoin.", 8),
(2, "Déposer une tranche de jambon sur chaque escalope, ajouter un peu de fromage râpé.", 8),
(3, "Rouler les escalopes et les ficeler", 8),
(4, "Faire chauffer l’huile d’olive dans une poêle.", 8),
(5, "Faire dorer les paupiettes de chaque côté pendant 5 minutes.", 8),
(6, "Ajouter l’oignon émincé et les champignons coupés en morceaux.", 8),
(7, "Ajouter la crème fraîche, le thym, saler et poivrer.", 8),
(8, "Laisser mijoter à feu doux pendant 30 minutes en couvrant.", 8),
(9, "Retirer les ficelles et servir les paupiettes avec des légumes ou du riz.", 8),
(1, "Dans une casserole, faire chauffer le lait avec la vanille jusqu’à frémissement.", 9),
(2, "Pendant ce temps, fouetter les œufs avec le sucre jusqu'à ce que le mélange blanchisse.", 9),
(3, "Ajouter la farine et bien mélanger.", 9),
(4, "Verser le lait chaud progressivement sur le mélange œufs-sucre-farine en fouettant bien.", 9),
(5, "Reverser dans la casserole et faire épaissir à feu doux en remuant constamment.", 9),
(6, "Beurrer un moule et y verser la préparation.", 9),
(7, "Enfourner à 180°C pendant 40 minutes jusqu’à ce que le flan soit bien doré sur le dessus.", 9),
(8, "Laisser refroidir avant de démouler et déguster bien frais.", 9),
(1, "Éplucher et couper les légumes en dés.", 10),
(2, "Faire revenir l’oignon émincé et l’ail dans une grande poêle avec l’huile d’olive.", 10),
(3, "Ajouter les carottes et laisser cuire 5 min, puis ajouter la courgette, le poivron et l’aubergine.", 10),
(4, "Assaisonner avec du sel, du poivre et le curry. Ajouter le lait et laisser mijoter 20 min à feu doux.", 10),
(5, "Pendant ce temps, cuire le riz selon les instructions.", 10),
(6, "Servir le curry de légumes chaud avec le riz.", 10),
(1, "Préparer une pâte en mélangeant la farine, le beurre fondu et une pincée de sel. Former une boule et laisser reposer.", 11),
(2, "Cuire les épinards dans une poêle avec un peu d’huile d’olive jusqu’à ce qu’ils réduisent.", 11),
(3, "Dans un bol, battre les œufs avec le lait, ajouter le fromage râpé, le sel et le poivre.", 11),
(4, "Étaler la pâte dans un moule, verser les épinards puis l’appareil à quiche.", 11),
(5, "Cuire à 180°C pendant 40 min.", 11),
(6, "Servir chaud ou froid avec une salade.", 11),
(1, "Cuire les lentilles dans une casserole d’eau bouillante pendant 25 min, égoutter.", 12),
(2, "Éplucher et couper les légumes en petits morceaux.", 12),
(3, "Faire revenir l’oignon et l’ail hachés dans une poêle avec l’huile d’olive.", 12),
(4, "Ajouter les carottes et laisser cuire 5 min avant d’ajouter la courgette.", 12),
(5, "Incorporer les lentilles cuites, assaisonner avec du thym, du sel et du poivre.", 12),
(6, "Laisser mijoter encore 5 min et servir chaud.", 12);
